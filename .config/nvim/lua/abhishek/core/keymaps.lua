...
keymap.set("n", "<leader>bn", "<cmd>tabnew<CR>", { desc = "Open new tab" }) --  new tab

keymap.set("n", "<leader>u", "<cmd>UndotreeToggle<CR>", { desc = "Undotree toggle side panel" }) --  Undotree toggle side panel
